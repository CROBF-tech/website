...
export const TEAM_MEMBERS = {
    ...
    Ezequiel: {
        fullName: 'Ezequiel Casiano',
        logo: '/founders/ezequiel_casiano.png',
        email: 'ezequielcasiano@gmail.com',
        gitHub: 'https://github.com/yoezequiel',
        linkedin: 'https://www.linkedin.com/in/yoezequiel',
        link: '/founders/ezequiel_casiano',
        profession: 'Desarrollador Full Product',
        description:
            'Líder: define visión y roadmap, prioriza por valor y coordina equipos cross‑funcionales para lanzar productos escalables y medibles.',
        index: 2,
    },
    Leandro: {
