export default {
    ...
    "about.philosophy.learningDept": "A space where we explore new technologies, improve our skills, and prepare for future challenges. Here, everyone collaborates without hierarchies, sharing knowledge and growing together.",
    "about.philosophy.profitDept.title":"<strong>Profit Department</strong>",
    "about.philosophy.profitDept": "Focused on commercial projects that leverage our individual and collective strengths. This department allows us to transform our ideas into real solutions for clients and users.",
